      ...
      <div className="bg-white  w-full  h-full rounded-2xl shadow-md p-10  dark:bg-gray-900">
        ...
        <form>
          <div className="flex mt-5 gap-5 items-center">
            ...
            placeholder="Para:"
              type="text"
              className="border-0 w-1/2 border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-transparent dark:bg-gray-900"
            />
          </div>
          ...
          <div className="flex flex-col justify-center mt-5 gap-5 ">
            ...
            <textarea placeholder="Escriba el mensaje" className="border-0 w-full h-96 border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none   focus:border-transparent dark:bg-gray-900"></textarea>
          </div>
